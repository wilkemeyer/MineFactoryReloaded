...
public class Thaumcraft
{
	...
	{
		/*
		parseAspects(*OilFabricator, "Not Sure What Aspects Oil Is Getting. Wait On Other Mods I Recommend.");
		parseAspects(*Tracks, "Tracks Currently Have No Aspects.");
		parseAspects(autoEnchanter, "8 Preacantio, 4 Cognitio, 4 Fabricio, 5 Machina");
		parseAspects(autoAnvil, "3 Permutatio, 5 Fabrico, 10 Metallum, 5 Machina");
		parseAspects(autoBrewer, "4 ignis, 2 Fabrico, 2 Aqua, 2 Praecantio, 5 Machina");
		parseAspects(autoDisenchanter, "4 Praecantio, 4 Permutatio, 5 Machina");
		parseAspects(autoJukebox, "4 Sensus, 4 Aer, 5 Machina");
		parseAspects(autoSpawner, "4 Beastia, 4 Examinis, 2 Itor, 5 Machina");
		parseAspects(biofuelGenerator, "5 Potentia, 3 Herba, 5 Machina");
		parseAspects(bioReactor, "4 Herba, 2 Potentia, 5 Machina");
		parseAspects(blockBreaker, "4 Perfodio, 5 Machina, 5 Metalum, 3 Lucrum");
		parseAspects(blockSmasher, "15 Perditio, 5 Machina");
		parseAspects(breader, "2 Beastia, 2 Famus, 5 Machina");
		parseAspects(chronotyper, "3 Tempus, 3 Beastia, 5 Machina, 3 Sensus");
		parseAspects(composter, "2 Beastia, 2 Aqua, 5 Machina");
		parseAspects(deepStorageUnit, "20 Vacous, 5 Machina, 5 Alienis");
		parseAspects(ejector, "4 Motus, 5 Machina");
		parseAspects(enchantmentRouter, "1 Motus, 4 Itor, 2 Sensus, 5 Machina, 1 Praecantio");
		parseAspects(fertilizer, "6 Herba, 5 Machina, 1 Vitreus, 3 Victus");
		parseAspects(fisher, "3 Aqua, 5 Machina, 4 Metalum, 2 Instrumentum");
		parseAspects(fruitPicker, "2 Herba, 4 Meso, 5 Machina");
		parseAspects(grinder, "10 Telum, 3 Mortus, 7 Meto, 5 Machina, 4 Metalum, 2 Lucrum");
		parseAspects(itemCollector, "4 Vacous, 5 Machina, 2 Arbor, 4 Motus");
		parseAspects(itemRouter, "2 Motus, 4 Itor, 2 Sensus,  5 Machina");
		parseAspects(laserDrillPrecharger, "4 Lux, 5 Machina, 5 Potentia, 2 Ligus");
		parseAspects(laserDrill, "5 Perfodio, 15 Lux, 5 Machina, 4 Victus");
		parseAspects(lavaFabricator, "4 ignis, 4 Saxum, 4 Fabrico, 5 Machina");
		parseAspects(liquicrafter, "5 Aqua, 5 Fabrico, 5 Machina");
		parseAspects(liquidRouter, "1 Motus, 4 Itor, 2 Sensus, 5 Machina, 1 Aqua");
		parseAspects(meatPacker, "2 Ordo, 2 Corpus, 2 Famus, 5 Machina");
		parseAspects(planter, "4 Herba, 2 Granum, 4 Meso, 5 Machina");
		parseAspects(programableRednetController, "10 Cogntio, 5 Machina");
		parseAspects(rednoteBlock, "4 Aer, 4 Sensus, 5 Machina");
		parseAspects(rancher, "6 Meto, 5 Machina, 4 Metalum, 2 Instrumentum");
		parseAspects(sewer, "1 Venenum, 3 Aqua 5 Machina, 4 Beastia");
		parseAspects(slaughterhouse, "12 Telum, 5 Mortus, 5 Machina, 12 Metalum, 6 Lucrum");
		parseAspects(sludgeBoiler, "3 Venenum, 3 Terra, 2 Aqua, 5 Machina, 2 ignis");
		parseAspects(unifier, "5 Ordo, 2 Alienis, 5 Machina");
		parseAspects(veterinaryStation, "4 Sano, 5 Machina, 4 Beastia");
		parseAspects(weatherCollector, " 4 Vacous, 5 Machina, 5 Metalum, 4 Tempestas");//*/
