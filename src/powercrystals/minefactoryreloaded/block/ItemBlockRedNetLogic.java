...
public class ItemBlockRedNetLogic extends ItemBlock {
	...
	static {
		...
		pages.appendTag(new NBTTagString("Features\n\n* 16 I/O points on\n  each side\n* 16 internal\n  variables\n* 6 user-defined\n  circuits\n" +
				"* Expandable with\n  LX-100, 300, 500\n  expansion modules\n  (sold separately)"));
